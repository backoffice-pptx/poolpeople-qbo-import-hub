...
function buildPurchaseRows_(purchases) {
  return purchases.map(purchase => {
    ...
    const linked = summarizeLinkedTransactionsForTypes_(linkedTransactions, ['ReimburseCharge']);
    ...
    return [
      ...
      jsonStringifyCellSafe_(purchase.PurchaseEx),
