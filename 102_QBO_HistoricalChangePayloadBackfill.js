...
function qboHistoricalPayloadSourceAvailable_(s){return (s.sourceAcquisitionType===QBO_STATE_CAPTURE.SOURCE_ACQUISITION_TYPE||s.sourceAcquisitionType===QBO_STATE_CAPTURE.LEGACY_SOURCE_ACQUISITION_TYPE)&&s.sourceStatus===QBO_STATE_CAPTURE.SOURCE_STATUS_AVAILABLE&&!!s.masterBackupFileId&&!isQboStateCaptureControlledTestRunId_(s.sourceRunId);}
